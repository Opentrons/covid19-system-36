...
metadata = {
    'protocolName': 'Version 2 S14 Station B MagMax (400µl sample input)',
...
ELUTION_VOL = 50
STARTING_VOL = 400 + 10 + 550  # 400µL of sample, 10µL proteinase K, 550µL of binding buffer
TIP_TRACK = False
PARK = True
...
minutes.')"""
    for _ in range(4):
        ...
        sleep(1)
    ctx.pause("Please move plate to thermoblock for evaporation. Replace and click RESUME.")
